        ...
        <div class="row my-5">
            <div class="row h-100 p-5 bg-light border rounded-3">
                <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                    <img src="https://m.media-amazon.com/images/M/MV5BZWI3ZThmYzUtNDJhOC00ZWY4LThiNmMtZDgxNjE3Yzk4NDU1XkEyXkFqcGdeQXVyNTk5Nzg1NjQ@._V1_SX300.jpg" height="400px" class="card-img-top col-10" alt="...">
            ...
            <div class="col-lg-2 col-md-3 col-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">{{Str::substr($movie->description, 70)}}...</p>
